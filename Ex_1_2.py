...
def get_shop_list_by_dishes(dishes, person_count):
    ...
    for dish_name in dishes:  # проводим итерацию списка полученных блюд
        if dish_name in cook_book:
            for ings in cook_book[dish_name]:  # проводим итерацию ингридиентов в блюде
                meas_quan_list = dict()
...
print(cook_book)
print(get_shop_list_by_dishes(dishes=['Омлет', 'Фахитос'], person_count=2))